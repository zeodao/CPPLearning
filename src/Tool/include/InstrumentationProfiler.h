...
#if ZTOOLPROFILE
#define ZTOOLPROFILE_SCOPE(name) InstrumentationTimer timer##__LINE__(name)
#define ZTOOLPROFILE_FUNCTION() ZTOOLPROFILE_SCOPE(__FUNCSIG__)
#else
#define ZTOOLPROFILE_SCOPE(name)
